    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_phone', models.CharField(max_length=30, null=True, unique=True)),
                ('user_image', models.ImageField(blank=True, null=True, upload_to='userinfo/')),
                ...
                ('qua', models.CharField(blank=True, default='no', max_length=30, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='whodonate',
